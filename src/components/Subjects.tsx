    ...
    <section className="py-16 bg-gray-50">
      <div className="container mx-auto px-6">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold mb-4">المواد <span className="text-brand-blue">الدراسية</span></h2>
          <p className="text-gray-600 max-w-2xl mx-auto">
            اختر من مجموعة واسعة من المواد الدراسية لجميع المراحل التعليمية
          </p>
        </div>
