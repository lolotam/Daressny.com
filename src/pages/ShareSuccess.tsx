        ...
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mx-auto bg-white rounded-xl shadow-sm p-8">
            <div className="text-center mb-8">
              <h1 className="text-3xl font-bold mb-4">شارك قصة نجاحك</h1>
              <p className="text-gray-600">
                ✨ نؤمن أن النجاح يلهم الآخرين!
                <br />
                شاركنا قصة نجاحك مع منصة "درسني"، سواء كنت طالبًا حقق التفوق بمساعدة دروسنا أو مدرسًا أثرى مسيرته التعليمية معنا.
              </p>
            </div>
